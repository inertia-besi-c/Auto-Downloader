...
# WINDOWS: Use this directory if you are on a windows system running bash /mnt/c/Users/inertia/Desktop
...
cd /mnt/c/Users/inertia/       # Heads to the directory specified
...
CG1=192.168.60.100:5555       # This is a caregiver watch
CG2=192.168.60.101:5555       # This is a caregiver watch
PT1=192.168.60.102:5555       # This is a patient watch
PT2=192.168.60.103:5555       # This is a patient watch
...
WATCHIP="$CG1 ""$CG2 ""$PT1 ""$PT2 ""$WatchIP4 ""$WatchIP5 ""$WatchIP6 ""$WatchIP7 ""$WatchIP8 ""$WatchIP9 ""$WatchIP10 "       # Possible watch IPs
...
IP_ADDRESS_IV="${IP_ADDRESS_III//authorizing/}"       # Removes authorizing in case device is not authorizing
